...
const envSchema = z.object({
  ...
  AUTH_RATE_LIMIT_MAX_LOGIN: z.coerce.number().int().positive().default(10),
  AUTH_RATE_LIMIT_MAX_REGISTER: z.coerce.number().int().positive().default(6),
  AUTH_RATE_LIMIT_MAX_REFRESH: z.coerce.number().int().positive().default(30),
